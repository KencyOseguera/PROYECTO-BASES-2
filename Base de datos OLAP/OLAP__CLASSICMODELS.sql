...
GO
CREATE PROCEDURE LlenarTablaOLAPHechos
AS
BEGIN
	SELECT EMPLOYEES.EMPLOYEENUMBER, CUSTOMERS.CUSTOMERNUMBER, PRODUCTS.PRODUCTCODE, CONVERT(DATE, ORDERDATE) TIEMPO_ID, PRODUCTLINES.PRODUCTLINE,
	...
	GROUP BY EMPLOYEES.EMPLOYEENUMBER, CUSTOMERS.CUSTOMERNUMBER, PRODUCTS.PRODUCTCODE, ORDERDATE, PRODUCTLINES.PRODUCTLINE
END;
